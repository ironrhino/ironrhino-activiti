...
<table class="table table-bordered">
	...
	<tr class="<#if !historicProcessInstance.endTime??&&!ad_has_next>info<#else>success</#if>">
		...
		<td><span class="user" data-username="${ad.assignee!}">${(statics['org.ironrhino.core.util.ApplicationContextUtils'].getBean('userDetailsService').loadUserByUsername(ad.assignee))!}</span></td>
